...
declare vm_folder="/Users/MinSuSong/VirtualBox\ VMs/test"
...
VBoxManage createhd --filename "/Users/MinSuSong/VirtualBox VMs/test"/${vm_name}.vdi \
...
VBoxManage storageattach ${vm_name} \
            ...
            --device 00 \
            --type dvddrive \
            --medium '/Users/MinSuSong/VirtualBox VMs/CentOS-7-x86_64-Minimal-1810.iso'
...
# MacOS the path to the iso file is:
...
VBoxManage storageattach ${vm_name} \
            ...
            --device 01 \
            --type hdd \
            --medium "/Users/MinSuSong/VirtualBox VMs/test"/${vm_name}.vdi \
            --nonrotational on
